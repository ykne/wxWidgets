...
- Build locale/*.mo catalogs via 'make -C locale allmo' before install; the
  git-archive source tarball only ships the .po sources, unlike the official
  release tarball which bundles precompiled .mo files
- Use .sni release suffix to avoid NVR collision with official Fedora wxGTK builds

* Sun Jul 05 2026 ykne <6250736+ykne@users.noreply.github.com> - 3.2.11-1
- Update to 3.2.11 snapshot with AppIndicator/SNI taskbar support (appindicator-sni-taskbar-3.2 branch)
